...
def main() -> None:
    ...
    add_para(doc, "Версия программы: v3.1.2", bold=True)
    add_para(
        doc,
    ...
    add_bullets(
        doc,
        [
            "[N/M] сайт — N стр., K HIT, время | всего HIT | в работе: … — прогресс.",
            "[N/M] недоступен сайт — сайт недоступен (в Excel красным; строка в sites.txt с #).",
            "HIT [сайт] «фраза» url — находка.",
    ...
    add_para(doc, "Текущий релиз: v3.1.2", bold=True)
    doc.save(OUT)
    print(f"Wrote {OUT}")
